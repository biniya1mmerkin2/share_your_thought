  ...
  if (!user?.result?.name) {
    return (
      <Paper style={Style.paper} elevation={6}>
        <Typography variant="h5" textAlign={"center"}>
          {" "}
          Sign in first to Share Thought in this app
        </Typography>
      </Paper>
    );
  } else {
    return (
      <Paper style={Style.paper} elevation={6}>
        ...
        >
          <Typography style={Style.typo} variant="h6">
          ...
          <TextField
            ...
            onChange={(e) =>
              setPostDat({ ...postData, message: e.target.value })
            }
          />
          <TextField
            required
            ...
            value={postData.tags}
            onChange={(e) =>
              setPostDat({ ...postData, tags: e.target.value.split(",") })
            }
          />
          ...
          <div style={Style.div}>
            <Filebase
              ...
              multiple={false}
              onDone={({ base64 }) =>
                setPostDat({ ...postData, selectedFile: base64 })
              }
            ></Filebase>
          </div>
          <Button
